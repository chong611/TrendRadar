...
"""
    ...
    html += """
        ...
        function initSearch() {
            ...
            const totalCount = document.querySelectorAll('.news-item').length;
        ...
        function performSearch() {
            ...
            wordGroups.forEach(group => {
                ...
                newsItems.forEach(item => {
                    ...
                    const matchesSource = currentSourceFilter === 'all' || sourceName.includes(currentSourceFilter.toLowerCase());
                    ...
                    if (matchesKeyword && matchesSource) {
                        ...
                        if (keyword !== '') {
                            highlightKeyword(item.querySelector('.news-title'), keyword);
                        } else {
                            removeHighlight(item.querySelector('.news-title'));
                        }
                    } else {
            ...
            if (keyword === '' && currentSourceFilter === 'all') {
                searchStats.innerHTML = `显示全部 <strong id="totalCount">${visibleCount}</strong> 条新闻`;
            } else {
                searchStats.innerHTML = `找到 <strong>${visibleCount}</strong> 条匹配的新闻`;
            }
        ...
        function highlightKeyword(element, keyword) {
            ...
            element.querySelector('.news-link').innerHTML = highlightedText;
        }
        
        function removeHighlight(element) {
            const originalText = element.getAttribute('data-original');
            if (originalText) {
                element.querySelector('.news-link').textContent = originalText;
            }
        }
